package com.vishaka.Backend.controller;

import com.vishaka.Backend.entities.Tutorial;
import com.vishaka.Backend.repository.TutorialRepository;
...
public class TutorialController {
  ...
  public ResponseEntity<List<Tutorial>> getAllTutorials(
    ...
    try {
      ...
      else tutorials.addAll(tutorialRepository.findByTitleContainingIgnoreCase(title));
